...
namespace anjani{
    ...
    std::vector<pair> schedule(int n, std::vector<uint64_t> job_list){
        std::priority_queue<int, std::vector<int>, std::greater<int>> job_priority;
        std::vector<uint64_t> t_f(n);
